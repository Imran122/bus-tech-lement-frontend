...
import PdfExpenseCategoryReport from "@/pages/dashboard/pdf/PdfExpenseCategoryReport";
...
const ExpenseCategoryReport = () => {
  ...
  return (
    <section className="pt-4">
      ...
      <div>
        <Heading size={"h5"}>Expense Category Report</Heading>
        <div className="-mx-2 border overflow-hidden">
          <Table className="overflow-hidden">
            <TableCaption className="mt-0 border-t-[0.5px]">
              A list of your expense category reports
            </TableCaption>
            <TableHeader className="bg-gray-100">
              <TableRow>
                {["Index", "Expense Category Name", "Note", "Amount"].map(
                  (header) => (
