      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <GridWrapper>
          ...
          <InputWrapper
            ...
            error={errors?.refundPercentage?.message}
          >
            <Input
              onChange={(e: ChangeEvent<HTMLInputElement>) => {
                const inputValue = +e.target.value;
                setValue("refundPercentage", inputValue);
                if (inputValue) {
                  setError("refundPercentage", { type: "custom", message: "" });
                } else {
                  setError("refundPercentage", {
                    type: "custom",
