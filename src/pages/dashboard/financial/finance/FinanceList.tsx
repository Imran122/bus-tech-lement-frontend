...
interface IFinanceListProps {}

// interface IFinanceStateProps {
//   search: string;
//   actionData: any;
// }
...
const FinanceList: FC<IFinanceListProps> = () => {
  ...
  // const [supervisorState, setSuperVisorState] = useState<IFinanceStateProps>({
  //   search: "",
  //   actionData: {},
  // });
    ...
    <PageWrapper>
      <TableWrapper
        subHeading={translate(
          "ফাইন্যান্স তালিকা এবং সকল তথ্য উপাত্ত",
          "Finance list and all ralevnet information & data"
        )}
                ...
                <DialogTrigger asChild>
                  ...
                  >
                    ...
                    <span className="custom-tooltip-top">
                      {translate("ফাইন্যান্স যুক্ত করুন", "Add Finance")}
                    </span>
                  </Button>
                </DialogTrigger>
