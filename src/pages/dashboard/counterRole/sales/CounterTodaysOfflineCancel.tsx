...
const CounterTodaysOfflineCancel: FC<ISalesListProps> = () => {
    ...
    <PageWrapper>
      <TableWrapper
        subHeading={translate(
          "আজকের অফলাইন বাতিলকরণ সেলস তথ্য উপাত্ত",
          "Today's Offline Cancel Sales Information"
        )}
        heading={translate(
          "আজকের অফলাইন বাতিলকরণ সেলস",
      ...
      >
        ...
        <DataTable
          ...
          pagination
          columns={columns}
          data={salesTickitList?.data?.cancelHistory || []}
        />
      </TableWrapper>
...
export default CounterTodaysOfflineCancel;
