...
const CounterTodaysSale: FC<ISalesListProps> = () => {
    ...
    <PageWrapper>
      <TableWrapper
        subHeading={translate(
          "আজকের অনলাইন সেলস তথ্য উপাত্ত",
          "Today's Online Sales Information"
        )}
        heading={translate("আজকের অনলাইন সেলস", "Today's Online Sales")}
      >
        ...
        <DataTable
          ...
          pagination
          columns={columns}
          data={salesTickitList?.data?.onlineHistory || []}
        />
      </TableWrapper>
...
export default CounterTodaysSale;
