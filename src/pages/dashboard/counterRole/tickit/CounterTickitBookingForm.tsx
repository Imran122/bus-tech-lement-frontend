      ...
      <PageTransition>
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="grid grid-cols-12 gap-5">
            <div className="col-span-5 border border-green-400">
            ...
            <div className="col-span-7 border border-red-400 p-3">
              <div className="relative inline-block w-full h-32 border-2 ">
                <h2 className="absolute -top-3 left-2  px-2 bg-gray-300">
              ...
              <PageTransition className="flex  lg:flex-row flex-col gap-6 items-center justify-center w-full">
                <RadioGroup
              ...
              <div>
                <PageTransition className="flex border flex-col justify-between w-full">
                  <div>
                    <Heading size="h4">
                      {translate(
