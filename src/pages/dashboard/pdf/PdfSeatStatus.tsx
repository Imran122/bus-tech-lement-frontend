    ...
    <Document>
      <Page size="A4" style={styles.page}>
        <View style={styles.section}>
          ...
          Counter Booking Seat Status Report
          </Text>
          ...
          <View style={styles.table}>
            ...
            <View style={styles.tableRow}>
              ...
              <View style={styles.tableHeader}>
                <Text>Booked Seat No.</Text>
              </View>
              <View style={styles.tableHeader}>
                <Text>Sold Seat No.</Text>
              </View>
              <View style={styles.tableHeader}>
              ...
              result.map((status, index) => (
                <View style={styles.tableRow} key={index}>
                  <View style={styles.tableCol}>
                    <Text>{status?.counterName}</Text>
                  </View>
                  <View style={styles.tableCol}>
                    <Text>{status?.orderBy}</Text>
                  </View>
                  <View style={styles.tableCol}>
                    <Text>{status?.bookSeat}</Text>
                  </View>
                  <View style={styles.tableCol}>
                    <Text>{status?.soldSeat}</Text>
                  </View>
                  <View style={styles.tableCol}>
                    <Text>{status?.passengerName}</Text>
                  </View>
                  <View style={styles.tableCol}>
                    <Text>{status?.passengerPhone}</Text>
                  </View>
                </View>
              ))}
          </View>
