      ...
      <Tabs defaultValue="config_list" className="my-2">
        <TabsList className="border">
          ...
          <TabsTrigger value="update_config_list" className="font-bold">
            {" "}
            <LuClipboardPaste className="button-icon-size mr-1" />Update Config List
          </TabsTrigger>
        </TabsList>
        {/* CONFIG LIST CONTAINER  */}
        <TabsContent className="-mt-8" value="config_list">
          <CoachConfigurationList />
        </TabsContent>
        {/* UPATE CONFIG LIST CONTAINER */}
        <TabsContent className="-mt-8" value="update_config_list">
