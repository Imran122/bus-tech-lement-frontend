          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <GridWrapper>
              ...
              >
                ...
                >
                  <SelectTrigger id="supervisorId" className="w-full">
                    <SelectValue
                      placeholder={translate(
                        addUpdateCoachConfigurationForm.supervisorId.placeholder
                          .bn,
                        addUpdateCoachConfigurationForm.supervisorId.placeholder
                          .en
                      )}
              ...
              >
                ...
                >
                  <SelectTrigger id="fromCounterId" className="w-full">
                    <SelectValue
                      placeholder={translate(
                        addUpdateCoachConfigurationForm.fromCounterId
                          .placeholder.bn,
                        addUpdateCoachConfigurationForm.fromCounterId
                          .placeholder.en
                      )}
              ...
              <InputWrapper
                ...
                label={translate(
                  addUpdateCoachConfigurationForm?.destinationCounterId.label
                    .bn,
                ...
                >
                  <SelectTrigger id="coachClass" className="w-full">
                    <SelectValue
                      placeholder={translate(
                        //@ts-ignore
                        addUpdateCoachConfigurationForm.coachClass.placeholder
                          .bn,
                        //@ts-ignore
                        addUpdateCoachConfigurationForm.coachClass.placeholder
                          .en
              ...
              >
                ...
                >
                  <SelectTrigger id="coachType" className="w-full">
                    <SelectValue
                      placeholder={translate(
                        addUpdateCoachConfigurationForm.coachType.placeholder
                          .bn,
                ...
                >
                  ...
                  <SelectContent>
                    {!faresLoading &&
                      ...
                      faresData?.data?.map(
                        (singleFare: any, fareIndex: number) => (
                          <SelectItem
                            key={fareIndex}
                    ...
                    {faresLoading && !faresData?.data?.length && (
                      <SelectSkeleton />
                    )}
                  </SelectContent>
                </Select>
              ...
              >
                <Input
                  ...
                  type="number"
                  placeholder={translate(
                    addUpdateCoachConfigurationForm.tokenAvailable.placeholder
                      .bn,
                    addUpdateCoachConfigurationForm.tokenAvailable.placeholder
                      .en
                  )}
