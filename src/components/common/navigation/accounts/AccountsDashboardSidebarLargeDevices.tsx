...
interface IAccountsDashboardSidebarLargeDevicesProps {}

const AccountsDashboardSidebarLargeDevices: FC<
  IAccountsDashboardSidebarLargeDevicesProps
> = () => {
...
export default AccountsDashboardSidebarLargeDevices;
