...
interface IDashboardSidebarLargeDevicesProps {}

const DashboardSidebarLargeDevices: FC<
  IDashboardSidebarLargeDevicesProps
> = () => {
...
export default DashboardSidebarLargeDevices;
