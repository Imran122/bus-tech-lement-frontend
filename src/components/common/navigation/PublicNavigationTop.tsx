...
const PublicNavigationTop = () => {
  ...
  return (
    <header className="sticky z-40 top-0 bg-primary flex items-center justify-between py-1 px-8">
      <h1 className="w-3/12 text-sm font-semibold">
        <a href="">Email: {singleCms?.data?.email}</a>
      </h1>

      <div className="nav font-semibold text-lg">
        <ul className="flex items-center">
          <li className="text-sm font-semibold">Support Number:</li>
