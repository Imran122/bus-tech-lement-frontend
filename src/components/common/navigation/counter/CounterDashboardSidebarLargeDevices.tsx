...
interface ICounterDashboardSidebarLargeDevicesProps {}

const CounterDashboardSidebarLargeDevices: FC<
  ICounterDashboardSidebarLargeDevicesProps
> = () => {
...
export default CounterDashboardSidebarLargeDevices;
