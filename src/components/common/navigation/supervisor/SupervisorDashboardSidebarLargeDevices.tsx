...
interface ISupervisorDashboardSidebarLargeDevicesProps {}

const SupervisorDashboardSidebarLargeDevices: FC<
  ISupervisorDashboardSidebarLargeDevicesProps
> = () => {
...
export default SupervisorDashboardSidebarLargeDevices;
